...
Increasing numbers of young individuals are affected by cardiac conditions, yet early screening is limited, costly, and time-consuming.The challenge is to create a solution that is:
...
🛠️ Tech Stack
  Programming, Python, Streamlit, FPDF (PDF generation), Libraries, NumPy, Pandas, Scikit-learn, Matplotlib, Seaborn, Joblib
...
4. Upload Data & Start Predictions: Open the local URL Streamlit provides:
- http://localhost:8501
